...
const
  ...
  RD_KAFKA_VERSION = $020002ff;
  RD_KAFKA_DEBUG_CONTEXTS = 'all,generic,broker,topic,metadata,feature,queue,msg,protocol,cgrp,' + 'security,fetch,interceptor,plugin,consumer,admin,eos,mock,assignor,' + 'conf';
  { TODO : Unable to convert function-like macro: }
  ...
  RD_KAFKA_EVENT_BACKGROUND = $200;
  RD_KAFKA_EVENT_CREATEACLS_RESULT = $400;
  RD_KAFKA_EVENT_DESCRIBEACLS_RESULT = $800;
  RD_KAFKA_EVENT_DELETEACLS_RESULT = $1000;
  RD_KAFKA_EVENT_LISTCONSUMERGROUPS_RESULT = $2000;
  RD_KAFKA_EVENT_DESCRIBECONSUMERGROUPS_RESULT = $4000;
  RD_KAFKA_EVENT_LISTCONSUMERGROUPOFFSETS_RESULT = $8000;
  RD_KAFKA_EVENT_ALTERCONSUMERGROUPOFFSETS_RESULT = $10000;
...
type
  ...
  Prd_kafka_group_result_s = Pointer;
  PPrd_kafka_group_result_s = ^Prd_kafka_group_result_s;
  Prd_kafka_acl_result_s = Pointer;
  PPrd_kafka_acl_result_s = ^Prd_kafka_acl_result_s;
  Paddrinfo = Pointer;
  PPaddrinfo = ^Paddrinfo;
  Prd_kafka_Node_s = Pointer;
  PPrd_kafka_Node_s = ^Prd_kafka_Node_s;
  ...
  Prd_kafka_DeleteRecords_s = Pointer;
  PPrd_kafka_DeleteRecords_s = ^Prd_kafka_DeleteRecords_s;
  Prd_kafka_ConsumerGroupListing_s = Pointer;
  PPrd_kafka_ConsumerGroupListing_s = ^Prd_kafka_ConsumerGroupListing_s;
  Prd_kafka_ListConsumerGroupsResult_s = Pointer;
  PPrd_kafka_ListConsumerGroupsResult_s = ^Prd_kafka_ListConsumerGroupsResult_s;
  Prd_kafka_ConsumerGroupDescription_s = Pointer;
  PPrd_kafka_ConsumerGroupDescription_s = ^Prd_kafka_ConsumerGroupDescription_s;
  Prd_kafka_MemberDescription_s = Pointer;
  PPrd_kafka_MemberDescription_s = ^Prd_kafka_MemberDescription_s;
  Prd_kafka_MemberAssignment_s = Pointer;
  PPrd_kafka_MemberAssignment_s = ^Prd_kafka_MemberAssignment_s;
  Prd_kafka_DeleteGroup_s = Pointer;
  PPrd_kafka_DeleteGroup_s = ^Prd_kafka_DeleteGroup_s;
  Prd_kafka_ListConsumerGroupOffsets_s = Pointer;
  PPrd_kafka_ListConsumerGroupOffsets_s = ^Prd_kafka_ListConsumerGroupOffsets_s;
  Prd_kafka_AlterConsumerGroupOffsets_s = Pointer;
  PPrd_kafka_AlterConsumerGroupOffsets_s = ^Prd_kafka_AlterConsumerGroupOffsets_s;
  Prd_kafka_DeleteConsumerGroupOffsets_s = Pointer;
  PPrd_kafka_DeleteConsumerGroupOffsets_s = ^Prd_kafka_DeleteConsumerGroupOffsets_s;
  Prd_kafka_AclBinding_s = Pointer;
  PPrd_kafka_AclBinding_s = ^Prd_kafka_AclBinding_s;
  Prd_kafka_DeleteAcls_result_response_s = Pointer;
  PPrd_kafka_DeleteAcls_result_response_s = ^Prd_kafka_DeleteAcls_result_response_s;
  ...
  Prd_kafka_group_result_t = Pointer;
  PPrd_kafka_group_result_t = ^Prd_kafka_group_result_t;
  Prd_kafka_acl_result_t = Pointer;
  PPrd_kafka_acl_result_t = ^Prd_kafka_acl_result_t;
  ...
  _anonymous_type_3 = record
    case Integer of
      ...
      8: (ptr: Pointer);
      9: ((** Padding size for future-proofness *)
    _pad: array [0..63] of UTF8Char);
  end;
  ...
  Prd_kafka_Node_t = Pointer;
  PPrd_kafka_Node_t = ^Prd_kafka_Node_t;
  ...
  Prd_kafka_consumer_group_state_t = ^rd_kafka_consumer_group_state_t;
  ...
  Prd_kafka_CreateAcls_result_t = Pointer;
  PPrd_kafka_CreateAcls_result_t = ^Prd_kafka_CreateAcls_result_t;
  Prd_kafka_DescribeAcls_result_t = Pointer;
  PPrd_kafka_DescribeAcls_result_t = ^Prd_kafka_DescribeAcls_result_t;
  Prd_kafka_DeleteAcls_result_t = Pointer;
  PPrd_kafka_DeleteAcls_result_t = ^Prd_kafka_DeleteAcls_result_t;
  ...
  Prd_kafka_DeleteRecords_result_t = Pointer;
  PPrd_kafka_DeleteRecords_result_t = ^Prd_kafka_DeleteRecords_result_t;
  Prd_kafka_ListConsumerGroups_result_t = Pointer;
  PPrd_kafka_ListConsumerGroups_result_t = ^Prd_kafka_ListConsumerGroups_result_t;
  Prd_kafka_DescribeConsumerGroups_result_t = Pointer;
  PPrd_kafka_DescribeConsumerGroups_result_t = ^Prd_kafka_DescribeConsumerGroups_result_t;
  Prd_kafka_DeleteGroups_result_t = Pointer;
  PPrd_kafka_DeleteGroups_result_t = ^Prd_kafka_DeleteGroups_result_t;
  Prd_kafka_DeleteConsumerGroupOffsets_result_t = Pointer;
  PPrd_kafka_DeleteConsumerGroupOffsets_result_t = ^Prd_kafka_DeleteConsumerGroupOffsets_result_t;
  Prd_kafka_AlterConsumerGroupOffsets_result_t = Pointer;
  PPrd_kafka_AlterConsumerGroupOffsets_result_t = ^Prd_kafka_AlterConsumerGroupOffsets_result_t;
  Prd_kafka_ListConsumerGroupOffsets_result_t = Pointer;
  PPrd_kafka_ListConsumerGroupOffsets_result_t = ^Prd_kafka_ListConsumerGroupOffsets_result_t;
   ...
   * @returns an error code on failure, the error is logged but otherwise ignored.
   *)
  Prd_kafka_interceptor_f_on_response_received_t = function(rk: Prd_kafka_t; sockfd: Integer; const brokername: PUTF8Char; brokerid: Int32; ApiKey: Int16; ApiVersion: Int16; CorrId: Int32; size: NativeUInt; rtt: Int64; err: rd_kafka_resp_err_t; ic_opaque: Pointer): rd_kafka_resp_err_t; cdecl;
   ...
   * @returns an error code on failure, the error is logged but otherwise ignored.
   *)
  Prd_kafka_interceptor_f_on_broker_state_change_t = function(rk: Prd_kafka_t; broker_id: Int32; const secproto: PUTF8Char; const name: PUTF8Char; port: Integer; const state: PUTF8Char; ic_opaque: Pointer): rd_kafka_resp_err_t; cdecl;
  ...
  Prd_kafka_ResourcePatternType_t = ^rd_kafka_ResourcePatternType_t;
  Prd_kafka_ConfigResource_t = Pointer;
  PPrd_kafka_ConfigResource_t = ^Prd_kafka_ConfigResource_t;
  Prd_kafka_DeleteRecords_t = Pointer;
  PPrd_kafka_DeleteRecords_t = ^Prd_kafka_DeleteRecords_t;
  Prd_kafka_ConsumerGroupListing_t = Pointer;
  PPrd_kafka_ConsumerGroupListing_t = ^Prd_kafka_ConsumerGroupListing_t;
  Prd_kafka_ListConsumerGroupsResult_t = Pointer;
  PPrd_kafka_ListConsumerGroupsResult_t = ^Prd_kafka_ListConsumerGroupsResult_t;
  Prd_kafka_ConsumerGroupDescription_t = Pointer;
  PPrd_kafka_ConsumerGroupDescription_t = ^Prd_kafka_ConsumerGroupDescription_t;
  Prd_kafka_MemberDescription_t = Pointer;
  PPrd_kafka_MemberDescription_t = ^Prd_kafka_MemberDescription_t;
  Prd_kafka_MemberAssignment_t = Pointer;
  PPrd_kafka_MemberAssignment_t = ^Prd_kafka_MemberAssignment_t;
  Prd_kafka_DeleteGroup_t = Pointer;
  PPrd_kafka_DeleteGroup_t = ^Prd_kafka_DeleteGroup_t;
  Prd_kafka_ListConsumerGroupOffsets_t = Pointer;
  PPrd_kafka_ListConsumerGroupOffsets_t = ^Prd_kafka_ListConsumerGroupOffsets_t;
  Prd_kafka_AlterConsumerGroupOffsets_t = Pointer;
  PPrd_kafka_AlterConsumerGroupOffsets_t = ^Prd_kafka_AlterConsumerGroupOffsets_t;
  Prd_kafka_DeleteConsumerGroupOffsets_t = Pointer;
  PPrd_kafka_DeleteConsumerGroupOffsets_t = ^Prd_kafka_DeleteConsumerGroupOffsets_t;
  Prd_kafka_AclBinding_t = Pointer;
  PPrd_kafka_AclBinding_t = ^Prd_kafka_AclBinding_t;
  Prd_kafka_AclBindingFilter_t = Pointer;
  PPrd_kafka_AclBindingFilter_t = ^Prd_kafka_AclBindingFilter_t;
  ...
  Prd_kafka_AclOperation_t = ^rd_kafka_AclOperation_t;
  ...
  Prd_kafka_AclPermissionType_t = ^rd_kafka_AclPermissionType_t;
  Prd_kafka_DeleteAcls_result_response_t = Pointer;
  PPrd_kafka_DeleteAcls_result_response_t = ^Prd_kafka_DeleteAcls_result_response_t;
 ...
 *)
function rd_kafka_topic_partition_list_find(const rktparlist: Prd_kafka_topic_partition_list_t; const topic: PUTF8Char; partition: Int32): Prd_kafka_topic_partition_t; cdecl;
 ...
 * @sa rd_kafka_sasl_background_callbacks_enable()
 *)
procedure rd_kafka_conf_enable_sasl_queue(conf: Prd_kafka_conf_t; enable: Integer); cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_conf_enable_sasl_queue';
...
type
  rd_kafka_conf_set_resolve_cb_resolve_cb = function(const node: PUTF8Char; const service: PUTF8Char; const hints: Paddrinfo; res: PPaddrinfo; opaque: Pointer): Integer; cdecl;
 ...
 * @remark The callback will be called from an internal librdkafka thread.
 *)
procedure rd_kafka_conf_set_resolve_cb(conf: Prd_kafka_conf_t; resolve_cb: rd_kafka_conf_set_resolve_cb_resolve_cb); cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_conf_set_resolve_cb';
 ...
 *         use it.
 *)
procedure rd_kafka_conf_set_engine_callback_data(conf: Prd_kafka_conf_t; callback_data: Pointer); cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_conf_set_engine_callback_data';
 ...
 *)
function rd_kafka_conf_get_default_topic_conf(conf: Prd_kafka_conf_t): Prd_kafka_topic_conf_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_conf_get_default_topic_conf';
 ...
 *         rd_kafka_mem_free()
 *)
function rd_kafka_mem_calloc(rk: Prd_kafka_t; num: NativeUInt; size: NativeUInt): Pointer; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_mem_calloc';
 ...
 *         rd_kafka_mem_free()
 *)
function rd_kafka_mem_malloc(rk: Prd_kafka_t; size: NativeUInt): Pointer; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_mem_malloc';
 ...
 * @sa rd_kafka_sasl_background_callbacks_enable()
 *)
function rd_kafka_queue_get_sasl(rk: Prd_kafka_t): Prd_kafka_queue_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_queue_get_sasl';
 ...
 *)
function rd_kafka_sasl_background_callbacks_enable(rk: Prd_kafka_t): Prd_kafka_error_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_sasl_background_callbacks_enable';
 ...
 * @returns NULL on success or an error object on error.
 *)
function rd_kafka_sasl_set_credentials(rk: Prd_kafka_t; const username: PUTF8Char; const password: PUTF8Char): Prd_kafka_error_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_sasl_set_credentials';
 ...
 *)
procedure rd_kafka_queue_yield(rkqu: Prd_kafka_queue_t); cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_queue_yield';
 ...
 *)
function rd_kafka_seek_partitions(rk: Prd_kafka_t; partitions: Prd_kafka_topic_partition_list_t; timeout_ms: Integer): Prd_kafka_error_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_seek_partitions';
 ...
 *)
function rd_kafka_consumer_close_queue(rk: Prd_kafka_t; rkqu: Prd_kafka_queue_t): Prd_kafka_error_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_consumer_close_queue';
 ...
 *)
function rd_kafka_consumer_closed(rk: Prd_kafka_t): Integer; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_consumer_closed';
 ...
 *)
function rd_kafka_incremental_assign(rk: Prd_kafka_t; const partitions: Prd_kafka_topic_partition_list_t): Prd_kafka_error_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_incremental_assign';
 ...
 *         rd_kafka_error_destroy().
 *)
function rd_kafka_incremental_unassign(rk: Prd_kafka_t; const partitions: Prd_kafka_topic_partition_list_t): Prd_kafka_error_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_incremental_unassign';
 ...
 *)
function rd_kafka_rebalance_protocol(rk: Prd_kafka_t): PUTF8Char; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_rebalance_protocol';
 ...
 *          lost, 0 otherwise.
 *)
function rd_kafka_assignment_lost(rk: Prd_kafka_t): Integer; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_assignment_lost';
 ...
 *         rd_kafka_consumer_group_metadata_destroy().
 *)
function rd_kafka_consumer_group_metadata_new_with_genid(const group_id: PUTF8Char; generation_id: Int32; const member_id: PUTF8Char; const group_instance_id: PUTF8Char): Prd_kafka_consumer_group_metadata_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_consumer_group_metadata_new_with_genid';
 ...
 * @return The node id.
 *)
function rd_kafka_Node_id(const node: Prd_kafka_Node_t): Integer; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_Node_id';
 ...
 *)
function rd_kafka_Node_host(const node: Prd_kafka_Node_t): PUTF8Char; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_Node_host';
 ...
 *)
function rd_kafka_Node_port(const node: Prd_kafka_Node_t): UInt16; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_Node_port';
 ...
 *)
function rd_kafka_consumer_group_state_name(state: rd_kafka_consumer_group_state_t): PUTF8Char; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_consumer_group_state_name';
 ...
 *)
function rd_kafka_consumer_group_state_code(const name: PUTF8Char): rd_kafka_consumer_group_state_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_consumer_group_state_code';
 ...
 *   RD_KAFKA_EVENT_DELETERECORDS_RESULT
 *)
function rd_kafka_event_DeleteRecords_result(rkev: Prd_kafka_event_t): Prd_kafka_DeleteRecords_result_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_event_DeleteRecords_result';
 ...
 *   RD_KAFKA_EVENT_LISTCONSUMERGROUPS_RESULT
 *)
function rd_kafka_event_ListConsumerGroups_result(rkev: Prd_kafka_event_t): Prd_kafka_ListConsumerGroups_result_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_event_ListConsumerGroups_result';
 ...
 *   RD_KAFKA_EVENT_DESCRIBECONSUMERGROUPS_RESULT
 *)
function rd_kafka_event_DescribeConsumerGroups_result(rkev: Prd_kafka_event_t): Prd_kafka_DescribeConsumerGroups_result_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_event_DescribeConsumerGroups_result';
 ...
 *   RD_KAFKA_EVENT_DELETEGROUPS_RESULT
 *)
function rd_kafka_event_DeleteGroups_result(rkev: Prd_kafka_event_t): Prd_kafka_DeleteGroups_result_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_event_DeleteGroups_result';
 ...
 *   RD_KAFKA_EVENT_DELETECONSUMERGROUPOFFSETS_RESULT
 *)
function rd_kafka_event_DeleteConsumerGroupOffsets_result(rkev: Prd_kafka_event_t): Prd_kafka_DeleteConsumerGroupOffsets_result_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_event_DeleteConsumerGroupOffsets_result';
 ...
 *   RD_KAFKA_EVENT_CREATEACLS_RESULT
 *)
function rd_kafka_event_CreateAcls_result(rkev: Prd_kafka_event_t): Prd_kafka_CreateAcls_result_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_event_CreateAcls_result';
 ...
 *   RD_KAFKA_EVENT_DESCRIBEACLS_RESULT
 *)
function rd_kafka_event_DescribeAcls_result(rkev: Prd_kafka_event_t): Prd_kafka_DescribeAcls_result_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_event_DescribeAcls_result';
 ...
 *   RD_KAFKA_EVENT_DELETEACLS_RESULT
 *)
function rd_kafka_event_DeleteAcls_result(rkev: Prd_kafka_event_t): Prd_kafka_DeleteAcls_result_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_event_DeleteAcls_result';
 ...
 *   RD_KAFKA_EVENT_ALTERCONSUMERGROUPOFFSETS_RESULT
 *)
function rd_kafka_event_AlterConsumerGroupOffsets_result(rkev: Prd_kafka_event_t): Prd_kafka_AlterConsumerGroupOffsets_result_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_event_AlterConsumerGroupOffsets_result';
 ...
 *   RD_KAFKA_EVENT_LISTCONSUMERGROUPOFFSETS_RESULT
 *)
function rd_kafka_event_ListConsumerGroupOffsets_result(rkev: Prd_kafka_event_t): Prd_kafka_ListConsumerGroupOffsets_result_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_event_ListConsumerGroupOffsets_result';
 ...
 *          has already been added to \p conf.
 *)
function rd_kafka_interceptor_add_on_response_received(rk: Prd_kafka_t; const ic_name: PUTF8Char; on_response_received: Prd_kafka_interceptor_f_on_response_received_t; ic_opaque: Pointer): rd_kafka_resp_err_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_interceptor_add_on_response_received';
 ...
 *          has already been added to \p conf.
 *)
function rd_kafka_interceptor_add_on_broker_state_change(rk: Prd_kafka_t; const ic_name: PUTF8Char; on_broker_state_change: Prd_kafka_interceptor_f_on_broker_state_change_t; ic_opaque: Pointer): rd_kafka_resp_err_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_interceptor_add_on_broker_state_change';
 ...
 *)
function rd_kafka_group_result_error(const groupres: Prd_kafka_group_result_t): Prd_kafka_error_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_group_result_error';
 ...
 *
 *)
function rd_kafka_group_result_name(const groupres: Prd_kafka_group_result_t): PUTF8Char; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_group_result_name';
 ...
 *)
function rd_kafka_group_result_partitions(const groupres: Prd_kafka_group_result_t): Prd_kafka_topic_partition_list_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_group_result_partitions';
 ...
 *)
function rd_kafka_AdminOptions_set_require_stable_offsets(options: Prd_kafka_AdminOptions_t; true_or_false: Integer): Prd_kafka_error_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_AdminOptions_set_require_stable_offsets';
 ...
 *)
function rd_kafka_AdminOptions_set_match_consumer_group_states(options: Prd_kafka_AdminOptions_t; const consumer_group_states: Prd_kafka_consumer_group_state_t; consumer_group_states_cnt: NativeUInt): Prd_kafka_error_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_AdminOptions_set_match_consumer_group_states';
 ...
 *)
function rd_kafka_ResourcePatternType_name(resource_pattern_type: rd_kafka_ResourcePatternType_t): PUTF8Char; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_ResourcePatternType_name';
 ...
 *)
function rd_kafka_DeleteRecords_new(const before_offsets: Prd_kafka_topic_partition_list_t): Prd_kafka_DeleteRecords_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_DeleteRecords_new';

(**
 * @brief Destroy and free a DeleteRecords object previously created with
 *        rd_kafka_DeleteRecords_new()
 *)
procedure rd_kafka_DeleteRecords_destroy(del_records: Prd_kafka_DeleteRecords_t); cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_DeleteRecords_destroy';
 ...
 *        The array itself is not freed.
 *)
procedure rd_kafka_DeleteRecords_destroy_array(del_records: PPrd_kafka_DeleteRecords_t; del_record_cnt: NativeUInt); cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_DeleteRecords_destroy_array';
 ...
 *)
procedure rd_kafka_DeleteRecords(rk: Prd_kafka_t; del_records: PPrd_kafka_DeleteRecords_t; del_record_cnt: NativeUInt; const options: Prd_kafka_AdminOptions_t; rkqu: Prd_kafka_queue_t); cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_DeleteRecords';
 ...
 *)
function rd_kafka_DeleteRecords_result_offsets(const result: Prd_kafka_DeleteRecords_result_t): Prd_kafka_topic_partition_list_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_DeleteRecords_result_offsets';
 ...
 *)
procedure rd_kafka_ListConsumerGroups(rk: Prd_kafka_t; const options: Prd_kafka_AdminOptions_t; rkqu: Prd_kafka_queue_t); cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_ListConsumerGroups';
 ...
 *)
function rd_kafka_ConsumerGroupListing_group_id(const grplist: Prd_kafka_ConsumerGroupListing_t): PUTF8Char; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_ConsumerGroupListing_group_id';
 ...
 *         else 0.
 *)
function rd_kafka_ConsumerGroupListing_is_simple_consumer_group(const grplist: Prd_kafka_ConsumerGroupListing_t): Integer; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_ConsumerGroupListing_is_simple_consumer_group';
 ...
 *)
function rd_kafka_ConsumerGroupListing_state(const grplist: Prd_kafka_ConsumerGroupListing_t): rd_kafka_consumer_group_state_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_ConsumerGroupListing_state';
 ...
 *)
function rd_kafka_ListConsumerGroups_result_valid(const result: Prd_kafka_ListConsumerGroups_result_t; cntp: PNativeUInt): PPrd_kafka_ConsumerGroupListing_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_ListConsumerGroups_result_valid';
 ...
 *         as the lifetime of the \p result object.
 *)
function rd_kafka_ListConsumerGroups_result_errors(const result: Prd_kafka_ListConsumerGroups_result_t; cntp: PNativeUInt): PPrd_kafka_error_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_ListConsumerGroups_result_errors';
 ...
 *)
procedure rd_kafka_DescribeConsumerGroups(rk: Prd_kafka_t; groups: PPUTF8Char; groups_cnt: NativeUInt; const options: Prd_kafka_AdminOptions_t; rkqu: Prd_kafka_queue_t); cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_DescribeConsumerGroups';
 ...
 *         as the lifetime of the \p result object.
 *)
function rd_kafka_DescribeConsumerGroups_result_groups(const result: Prd_kafka_DescribeConsumerGroups_result_t; cntp: PNativeUInt): PPrd_kafka_ConsumerGroupDescription_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_DescribeConsumerGroups_result_groups';
 ...
 *)
function rd_kafka_ConsumerGroupDescription_group_id(const grpdesc: Prd_kafka_ConsumerGroupDescription_t): PUTF8Char; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_ConsumerGroupDescription_group_id';
 ...
 *         as the lifetime of the \p grpdesc object.
 *)
function rd_kafka_ConsumerGroupDescription_error(const grpdesc: Prd_kafka_ConsumerGroupDescription_t): Prd_kafka_error_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_ConsumerGroupDescription_error';
 ...
 *         else 0.
 *)
function rd_kafka_ConsumerGroupDescription_is_simple_consumer_group(const grpdesc: Prd_kafka_ConsumerGroupDescription_t): Integer; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_ConsumerGroupDescription_is_simple_consumer_group';
 ...
 *         as the lifetime of the \p grpdesc object.
 *)
function rd_kafka_ConsumerGroupDescription_partition_assignor(const grpdesc: Prd_kafka_ConsumerGroupDescription_t): PUTF8Char; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_ConsumerGroupDescription_partition_assignor';
 ...
 * @return A group state.
 *)
function rd_kafka_ConsumerGroupDescription_state(const grpdesc: Prd_kafka_ConsumerGroupDescription_t): rd_kafka_consumer_group_state_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_ConsumerGroupDescription_state';
 ...
 *         as the lifetime of the \p grpdesc object.
 *)
function rd_kafka_ConsumerGroupDescription_coordinator(const grpdesc: Prd_kafka_ConsumerGroupDescription_t): Prd_kafka_Node_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_ConsumerGroupDescription_coordinator';
 ...
 *)
function rd_kafka_ConsumerGroupDescription_member_count(const grpdesc: Prd_kafka_ConsumerGroupDescription_t): NativeUInt; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_ConsumerGroupDescription_member_count';
 ...
 *         as the lifetime of the \p grpdesc object.
 *)
function rd_kafka_ConsumerGroupDescription_member(const grpdesc: Prd_kafka_ConsumerGroupDescription_t; idx: NativeUInt): Prd_kafka_MemberDescription_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_ConsumerGroupDescription_member';
 ...
 *)
function rd_kafka_MemberDescription_client_id(const member: Prd_kafka_MemberDescription_t): PUTF8Char; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_MemberDescription_client_id';
 ...
 *         as the lifetime of the \p member object.
 *)
function rd_kafka_MemberDescription_group_instance_id(const member: Prd_kafka_MemberDescription_t): PUTF8Char; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_MemberDescription_group_instance_id';
 ...
 *         as the lifetime of the \p member object.
 *)
function rd_kafka_MemberDescription_consumer_id(const member: Prd_kafka_MemberDescription_t): PUTF8Char; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_MemberDescription_consumer_id';
 ...
 *         as the lifetime of the \p member object.
 *)
function rd_kafka_MemberDescription_host(const member: Prd_kafka_MemberDescription_t): PUTF8Char; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_MemberDescription_host';
 ...
 *         as the lifetime of the \p member object.
 *)
function rd_kafka_MemberDescription_assignment(const member: Prd_kafka_MemberDescription_t): Prd_kafka_MemberAssignment_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_MemberDescription_assignment';
 ...
 *)
function rd_kafka_MemberAssignment_partitions(const assignment: Prd_kafka_MemberAssignment_t): Prd_kafka_topic_partition_list_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_MemberAssignment_partitions';
 ...
 *)
function rd_kafka_DeleteGroup_new(const group: PUTF8Char): Prd_kafka_DeleteGroup_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_DeleteGroup_new';

(**
 * @brief Destroy and free a DeleteGroup object previously created with
 *        rd_kafka_DeleteGroup_new()
 *)
procedure rd_kafka_DeleteGroup_destroy(del_group: Prd_kafka_DeleteGroup_t); cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_DeleteGroup_destroy';
 ...
 *        The array itself is not freed.
 *)
procedure rd_kafka_DeleteGroup_destroy_array(del_groups: PPrd_kafka_DeleteGroup_t; del_group_cnt: NativeUInt); cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_DeleteGroup_destroy_array';
 ...
 *)
procedure rd_kafka_DeleteGroups(rk: Prd_kafka_t; del_groups: PPrd_kafka_DeleteGroup_t; del_group_cnt: NativeUInt; const options: Prd_kafka_AdminOptions_t; rkqu: Prd_kafka_queue_t); cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_DeleteGroups';
 ...
 * @param cntp is updated to the number of elements in the array.
 *)
function rd_kafka_DeleteGroups_result_groups(const result: Prd_kafka_DeleteGroups_result_t; cntp: PNativeUInt): PPrd_kafka_group_result_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_DeleteGroups_result_groups';
 ...
 *          object when done.
 *)
function rd_kafka_ListConsumerGroupOffsets_new(const group_id: PUTF8Char; const partitions: Prd_kafka_topic_partition_list_t): Prd_kafka_ListConsumerGroupOffsets_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_ListConsumerGroupOffsets_new';

(**
 * @brief Destroy and free a ListConsumerGroupOffsets object previously
 *        created with rd_kafka_ListConsumerGroupOffsets_new()
 *)
procedure rd_kafka_ListConsumerGroupOffsets_destroy(list_grpoffsets: Prd_kafka_ListConsumerGroupOffsets_t); cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_ListConsumerGroupOffsets_destroy';
 ...
 *        The array itself is not freed.
 *)
procedure rd_kafka_ListConsumerGroupOffsets_destroy_array(list_grpoffsets: PPrd_kafka_ListConsumerGroupOffsets_t; list_grpoffset_cnt: NativeUInt); cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_ListConsumerGroupOffsets_destroy_array';
 ...
 *)
procedure rd_kafka_ListConsumerGroupOffsets(rk: Prd_kafka_t; list_grpoffsets: PPrd_kafka_ListConsumerGroupOffsets_t; list_grpoffsets_cnt: NativeUInt; const options: Prd_kafka_AdminOptions_t; rkqu: Prd_kafka_queue_t); cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_ListConsumerGroupOffsets';
 ...
 *         as the lifetime of the \p result object.
 *)
function rd_kafka_ListConsumerGroupOffsets_result_groups(const result: Prd_kafka_ListConsumerGroupOffsets_result_t; cntp: PNativeUInt): PPrd_kafka_group_result_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_ListConsumerGroupOffsets_result_groups';
 ...
 *          object when done.
 *)
function rd_kafka_AlterConsumerGroupOffsets_new(const group_id: PUTF8Char; const partitions: Prd_kafka_topic_partition_list_t): Prd_kafka_AlterConsumerGroupOffsets_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_AlterConsumerGroupOffsets_new';

(**
 * @brief Destroy and free a AlterConsumerGroupOffsets object previously
 *        created with rd_kafka_AlterConsumerGroupOffsets_new()
 *)
procedure rd_kafka_AlterConsumerGroupOffsets_destroy(alter_grpoffsets: Prd_kafka_AlterConsumerGroupOffsets_t); cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_AlterConsumerGroupOffsets_destroy';
 ...
 *        The array itself is not freed.
 *)
procedure rd_kafka_AlterConsumerGroupOffsets_destroy_array(alter_grpoffsets: PPrd_kafka_AlterConsumerGroupOffsets_t; alter_grpoffset_cnt: NativeUInt); cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_AlterConsumerGroupOffsets_destroy_array';
 ...
 * @remark The current implementation only supports one group per invocation.
 *)
procedure rd_kafka_AlterConsumerGroupOffsets(rk: Prd_kafka_t; alter_grpoffsets: PPrd_kafka_AlterConsumerGroupOffsets_t; alter_grpoffsets_cnt: NativeUInt; const options: Prd_kafka_AdminOptions_t; rkqu: Prd_kafka_queue_t); cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_AlterConsumerGroupOffsets';
 ...
 *         as the lifetime of the \p result object.
 *)
function rd_kafka_AlterConsumerGroupOffsets_result_groups(const result: Prd_kafka_AlterConsumerGroupOffsets_result_t; cntp: PNativeUInt): PPrd_kafka_group_result_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_AlterConsumerGroupOffsets_result_groups';
 ...
 *          object when done.
 *)
function rd_kafka_DeleteConsumerGroupOffsets_new(const group: PUTF8Char; const partitions: Prd_kafka_topic_partition_list_t): Prd_kafka_DeleteConsumerGroupOffsets_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_DeleteConsumerGroupOffsets_new';
 ...
 *)
procedure rd_kafka_DeleteConsumerGroupOffsets_destroy(del_grpoffsets: Prd_kafka_DeleteConsumerGroupOffsets_t); cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_DeleteConsumerGroupOffsets_destroy';
 ...
 *        The array itself is not freed.
 *)
procedure rd_kafka_DeleteConsumerGroupOffsets_destroy_array(del_grpoffsets: PPrd_kafka_DeleteConsumerGroupOffsets_t; del_grpoffset_cnt: NativeUInt); cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_DeleteConsumerGroupOffsets_destroy_array';
 ...
 * @remark The current implementation only supports one group per invocation.
 *)
procedure rd_kafka_DeleteConsumerGroupOffsets(rk: Prd_kafka_t; del_grpoffsets: PPrd_kafka_DeleteConsumerGroupOffsets_t; del_grpoffsets_cnt: NativeUInt; const options: Prd_kafka_AdminOptions_t; rkqu: Prd_kafka_queue_t); cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_DeleteConsumerGroupOffsets';
 ...
 * @param cntp is updated to the number of elements in the array.
 *)
function rd_kafka_DeleteConsumerGroupOffsets_result_groups(const result: Prd_kafka_DeleteConsumerGroupOffsets_result_t; cntp: PNativeUInt): PPrd_kafka_group_result_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_DeleteConsumerGroupOffsets_result_groups';

(**
 * @returns the error object for the given acl result, or NULL on success.
 *)
function rd_kafka_acl_result_error(const aclres: Prd_kafka_acl_result_t): Prd_kafka_error_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_acl_result_error';

(**
 * @returns a string representation of the \p acl_operation
 *)
function rd_kafka_AclOperation_name(acl_operation: rd_kafka_AclOperation_t): PUTF8Char; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_AclOperation_name';

(**
 * @returns a string representation of the \p acl_permission_type
 *)
function rd_kafka_AclPermissionType_name(acl_permission_type: rd_kafka_AclPermissionType_t): PUTF8Char; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_AclPermissionType_name';
 ...
 *)
function rd_kafka_AclBinding_new(restype: rd_kafka_ResourceType_t; const name: PUTF8Char; resource_pattern_type: rd_kafka_ResourcePatternType_t; const principal: PUTF8Char; const host: PUTF8Char; operation: rd_kafka_AclOperation_t; permission_type: rd_kafka_AclPermissionType_t; errstr: PUTF8Char; errstr_size: NativeUInt): Prd_kafka_AclBinding_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_AclBinding_new';
 ...
 * done.
 *)
function rd_kafka_AclBindingFilter_new(restype: rd_kafka_ResourceType_t; const name: PUTF8Char; resource_pattern_type: rd_kafka_ResourcePatternType_t; const principal: PUTF8Char; const host: PUTF8Char; operation: rd_kafka_AclOperation_t; permission_type: rd_kafka_AclPermissionType_t; errstr: PUTF8Char; errstr_size: NativeUInt): Prd_kafka_AclBindingFilter_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_AclBindingFilter_new';

(**
 * @returns the resource type for the given acl binding.
 *)
function rd_kafka_AclBinding_restype(const acl: Prd_kafka_AclBinding_t): rd_kafka_ResourceType_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_AclBinding_restype';
 ...
 *)
function rd_kafka_AclBinding_name(const acl: Prd_kafka_AclBinding_t): PUTF8Char; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_AclBinding_name';
 ...
 * @remark lifetime of the returned string is the same as the \p acl.
 *)
function rd_kafka_AclBinding_principal(const acl: Prd_kafka_AclBinding_t): PUTF8Char; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_AclBinding_principal';
 ...
 * @remark lifetime of the returned string is the same as the \p acl.
 *)
function rd_kafka_AclBinding_host(const acl: Prd_kafka_AclBinding_t): PUTF8Char; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_AclBinding_host';

(**
 * @returns the acl operation for the given acl binding.
 *)
function rd_kafka_AclBinding_operation(const acl: Prd_kafka_AclBinding_t): rd_kafka_AclOperation_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_AclBinding_operation';

(**
 * @returns the permission type for the given acl binding.
 *)
function rd_kafka_AclBinding_permission_type(const acl: Prd_kafka_AclBinding_t): rd_kafka_AclPermissionType_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_AclBinding_permission_type';

(**
 * @returns the resource pattern type for the given acl binding.
 *)
function rd_kafka_AclBinding_resource_pattern_type(const acl: Prd_kafka_AclBinding_t): rd_kafka_ResourcePatternType_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_AclBinding_resource_pattern_type';

(**
 * @returns the error object for the given acl binding, or NULL on success.
 *)
function rd_kafka_AclBinding_error(const acl: Prd_kafka_AclBinding_t): Prd_kafka_error_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_AclBinding_error';

(**
 * @brief Destroy and free an AclBinding object previously created with
 *        rd_kafka_AclBinding_new()
 *)
procedure rd_kafka_AclBinding_destroy(acl_binding: Prd_kafka_AclBinding_t); cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_AclBinding_destroy';
 ...
 *        The array itself is not freed.
 *)
procedure rd_kafka_AclBinding_destroy_array(acl_bindings: PPrd_kafka_AclBinding_t; acl_bindings_cnt: NativeUInt); cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_AclBinding_destroy_array';
 ...
 * @param cntp is updated to the number of elements in the array.
 *)
function rd_kafka_CreateAcls_result_acls(const result: Prd_kafka_CreateAcls_result_t; cntp: PNativeUInt): PPrd_kafka_acl_result_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_CreateAcls_result_acls';
 ...
 *)
procedure rd_kafka_CreateAcls(rk: Prd_kafka_t; new_acls: PPrd_kafka_AclBinding_t; new_acls_cnt: NativeUInt; const options: Prd_kafka_AdminOptions_t; rkqu: Prd_kafka_queue_t); cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_CreateAcls';
 ...
 * @param cntp is updated to the number of elements in the array.
 *)
function rd_kafka_DescribeAcls_result_acls(const result: Prd_kafka_DescribeAcls_result_t; cntp: PNativeUInt): PPrd_kafka_AclBinding_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_DescribeAcls_result_acls';
 ...
 *)
procedure rd_kafka_DescribeAcls(rk: Prd_kafka_t; acl_filter: Prd_kafka_AclBindingFilter_t; const options: Prd_kafka_AdminOptions_t; rkqu: Prd_kafka_queue_t); cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_DescribeAcls';
 ...
 * @param cntp is updated to the number of elements in the array.
 *)
function rd_kafka_DeleteAcls_result_responses(const result: Prd_kafka_DeleteAcls_result_t; cntp: PNativeUInt): PPrd_kafka_DeleteAcls_result_response_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_DeleteAcls_result_responses';

(**
 * @returns the error object for the given DeleteAcls result response,
 *          or NULL on success.
 *)
function rd_kafka_DeleteAcls_result_response_error(const result_response: Prd_kafka_DeleteAcls_result_response_t): Prd_kafka_error_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_DeleteAcls_result_response_error';
 ...
 * result_response.
 *)
function rd_kafka_DeleteAcls_result_response_matching_acls(const result_response: Prd_kafka_DeleteAcls_result_response_t; matching_acls_cntp: PNativeUInt): PPrd_kafka_AclBinding_t; cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_DeleteAcls_result_response_matching_acls';
 ...
 *)
procedure rd_kafka_DeleteAcls(rk: Prd_kafka_t; del_acls: PPrd_kafka_AclBindingFilter_t; del_acls_cnt: NativeUInt; const options: Prd_kafka_AdminOptions_t; rkqu: Prd_kafka_queue_t); cdecl;
  external LIBRDKAFKA_DLL name _PU + 'rd_kafka_DeleteAcls';
